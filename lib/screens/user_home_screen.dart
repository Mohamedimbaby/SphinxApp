...
import 'package:saleing/screens/cart_screen.dart';
import 'package:saleing/screens/complains/add_complain.dart';
import 'package:saleing/screens/order/order_bloc.dart';
import 'package:saleing/screens/order/ui/order_screen.dart';
...
class _UserHomeScreenState extends State<UserHomeScreen> {
  ...
  final TextEditingController _glassType = TextEditingController();
  ...
  List<String> pagesTitle = ["Quotation" , "Complain", "Order Tracking", "Cart","Shipping","Activity"];
  ...
  void initState() {
    ...
    loadingDialog.style("Add To cart...");
    super.initState();
  }
    ...
    return StreamBuilder<int>(
      ...
      builder: (context, snapshot) {
        return Scaffold(
          ...
          drawer: DrawerWidget(rxCurrentPageIndex,UserType.user),
        );
      }
    );
  }
  ...
  _buildSuitableScreen() {
    switch (rxCurrentPageIndex.value) {
      ...
      case 1:
        return const AddComplainScreen();
        case 2:
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Item Details" , style: boldTextStyle.copyWith(fontSize: 20),),
                const SizedBox(
                  height: 20,
                ),
                SizedBox(
                ...
                _buildButton(() async {
                  ...
                  if (formKey.currentState!.validate()) {
                        SharedPref.addToCart(Item(
                          ...
                          user.address,
                          _glassType.text,
                          dropdownValue == "packs" ? QuantityUnits.packs : QuantityUnits.tons
                      ));
